...
const DEFAULT_VERSIONS: VersionInfo[] = [
  { value: 'v0.9.9', label: 'v0.9.9', isLatest: true },
  { value: 'v0.9.8', label: 'v0.9.8', isLatest: false },
  { value: 'v0.9.7', label: 'v0.9.7', isLatest: false },
  { value: 'v0.9.6', label: 'v0.9.6', isLatest: false },
  { value: 'v0.9.5', label: 'v0.9.5', isLatest: false },
  { value: 'v0.9.4', label: 'v0.9.4', isLatest: false },
  { value: 'v0.9.3', label: 'v0.9.3', isLatest: false },
  { value: 'v0.9.2', label: 'v0.9.2', isLatest: false },
  { value: 'v0.9.1', label: 'v0.9.1', isLatest: false },
