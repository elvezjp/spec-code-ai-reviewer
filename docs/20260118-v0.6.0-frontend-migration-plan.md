...
| R-02 | API URL、モデル選択が保存されること | 3 |
| R-03 | Excelファイルをアップロードできること | 3 |
| R-04 | 複数の設計書ファイルの優先度を設定できること | 3 |
| R-05 | 設計書種別を選択できること | 3 |
| R-06 | プログラムファイルをアップロードできること | 3 |
| R-07 | マークダウン変換が実行できること | 3 |
| R-08 | 変換結果がプレビュー表示されること | 3 |
| R-09 | システムプロンプトのプリセットを選択できること | 3 |
| R-10 | システムプロンプトの各項目を編集できること | 3 |
| R-11 | レビューが実行できること | 3 |
| R-12 | レビュー結果がストリーミング表示されること | 3 |
| R-13 | ZIP出力が正常に動作すること | 3 |
