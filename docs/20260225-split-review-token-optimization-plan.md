...
- [ ] グループレビューでトークン超過エラー発生時、エラー内容（APIエラーメッセージ）がそのまま表示されること
- [ ] トークン超過エラー時、リトライ設定パネルが表示されること（「そのまま/要約」のラジオボタン）
- [ ] トークン超過エラー時、注意文（「⚠ 注意: 要約によって微妙なニュアンスや〜」）が表示されること
- [ ] トークン超過以外のエラー時（例: ネットワークエラー）、リトライ設定パネルが表示されないこと
...
- [ ] 結果統合でトークン超過エラー発生時、エラー内容がそのまま表示されること
- [ ] トークン超過エラー時、各グループのレビュー結果ごとに「そのまま/要約」のラジオボタンが表示されること
- [ ] トークン超過エラー時、注意文が表示されること
