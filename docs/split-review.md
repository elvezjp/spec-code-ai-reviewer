...
**ディレクトリ**: [versions/v0.8.0/frontend/src/features/reviewer/](../versions/v0.8.0/frontend/src/features/reviewer/)

| コンポーネント | ファイル | 役割 |
|---|---|---|
| 分割設定UI | [SplitSettingsSection.tsx](../versions/v0.8.0/frontend/src/features/reviewer/components/SplitSettingsSection.tsx) | batch/splitモード選択、分割深度設定、プレビュー |
| 実行画面 | [SplitExecutingScreen.tsx](../versions/v0.8.0/frontend/src/features/reviewer/components/SplitExecutingScreen.tsx) | 3フェーズの進捗表示（✓/⏳/○）、一時停止・再開 |
| 分割ロジック | [useSplitSettings.ts](../versions/v0.8.0/frontend/src/features/reviewer/hooks/useSplitSettings.ts) | 状態管理、API呼び出し、推定レビュー回数計算 |
| APIサービス | [api.ts](../versions/v0.8.0/frontend/src/features/reviewer/services/api.ts) | 各エンドポイントへのリクエスト |
